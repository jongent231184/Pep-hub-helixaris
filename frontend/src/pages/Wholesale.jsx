...
const Wholesale = () => (
  <Layout>
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <a href="mailto:ghpeptides@outlook.com" className="inline-block mt-6 bg-sky-500 hover:bg-sky-600 text-white px-7 py-3 rounded font-bold uppercase tracking-wider text-sm">Email Our Team</a>
    </div>
  </Layout>
);
