  ...
  <Layout>
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="prose max-w-none text-slate-700 space-y-4">
        <p>All products supplied by GH Peptides are intended for laboratory research use only. Not for human consumption.</p>
        ...
        <p>Buyers are responsible for compliance with all applicable laws in their jurisdiction. GH Peptides accepts no liability for misuse of the products.</p>
      </div>
    </div>
  </Layout>
);
